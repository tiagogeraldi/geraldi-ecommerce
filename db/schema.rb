...
ActiveRecord::Schema.define(version: 20160412201207) do
  ...
  add_index "product_shots", ["product_id"], name: "index_product_shots_on_product_id", using: :btree
  ...
  add_foreign_key "shippings", "order_items"
end
